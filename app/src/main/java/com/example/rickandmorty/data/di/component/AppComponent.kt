...
import com.example.rickandmorty.data.di.module.CharacterDetailsModule
...
@Singleton
@Component(modules = [CharactersProvider::class, ViewModelModule::class, CharacterDetailsModule::class])
